...
class QueryForm extends Component {
    ...
    _closeModal() {
        document.getElementById('QueryInfoClose').click();
    ...
    render() {
        ...
        return (
            <div className="modal fade" id="queryLogModal" role="dialog" data-backdrop="false" style={{ background: 'rgba(0, 0, 0, 0.5)' }}>
                <div className="modal-dialog">
                    ...
                    <div className="modal-content">
                        <div className="modal-header text-left">
                            ...
                            <h4 className="modal-title">Query Log</h4>
                        </div>
                        <div className="modal-body">
                            ...
                            <form className="form-horizontal label-left"
                                onSubmit={this.props.handleSubmit((history) => {
                                    this.props.submitSupportQueryForm(this.props.formValues.values, this.props.match.params.customerId, history)
                                ...
                                <div className="form-group">
                                    <div className="col-xs-9 col-xs-offset-3 text-left">
                                        <button type="submit" className="btn btn-success" style={{ marginRight: '10px' }} disabled={pristine || submitting}>
                                            ...
                                            Save</button>
                                        <button type="button" id="QueryInfoClose" className="btn btn-default" data-dismiss="modal" onClick={reset}>Cancel</button>
...
QueryForm = connect(
    mapStateToProps,
    actions
)(withRouter(QueryForm));

export default reduxForm({
    //validate,
    form: "QueryinfoReduxForm"
})(withRouter(QueryForm));