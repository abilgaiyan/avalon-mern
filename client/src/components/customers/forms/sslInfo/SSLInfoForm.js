...
class SSLInfoForm extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        // console.clear();
        // console.log("SSLInfoForm: ", nextProps.sslInfoForm);
        if (nextProps.sslInfoForm && !this.state.isInitializeState) {

            const initData = nextProps.sslInfoForm;
            ...
            return (
                <div>
                    ...
                    <form
                        ...
                        onSubmit={this.props.handleSubmit((history) => { this.props.submitsslInfoForm(this.props.formValues.values, this.props.match.params.customerId, history).then(this.setState({ disabled: true })) })}>
                        {this.renderFields()}
                        {
...
SSLInfoForm = connect(
    mapStateToProps,
    actions
)(withRouter(SSLInfoForm));

export default reduxForm({
    //validate,
    form: "SSLInfoReduxForm"
})(withRouter(SSLInfoForm));